...
def sync_user_contact(user, *, location_id: Optional[str] = None,
    ...
    Prefer existing ghl_contact_id (update custom fields only) — avoid create-by-phone
    which fails with "duplicated contacts" / wrong-location 403.
    """
    ...
    try:
        ...
        # Try to sync contact (create or recover contact id)
