    ...
    def post(self, request):
        ...
        try:
            ...
            if _buyer:
                ...
                # Self-checkout only (no temp buyer phone) — e.g. member paying for themselves
            ...
            if _inv_email:
                ...
                logger.info("Invoice email task queued for payment %s → %s (%s)", payment_id, _inv_email, _inv_name)
            else:
                logger.warning(
