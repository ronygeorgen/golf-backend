...
def build_oauth_url(state: str = '') -> str:
    ...
    params = {
        ...
        'scope': 'PAYMENTS_WRITE PAYMENTS_READ MERCHANT_PROFILE_READ ITEMS_WRITE ITEMS_READ SUBSCRIPTIONS_WRITE SUBSCRIPTIONS_READ CUSTOMERS_WRITE CUSTOMERS_READ ORDERS_WRITE ORDERS_READ INVOICES_WRITE',
        'session': 'false',
    }
    if state:
        params['state'] = state
